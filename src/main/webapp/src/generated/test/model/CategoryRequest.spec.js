...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenApiDefinition.CategoryRequest();
  });
  ...
  describe('CategoryRequest', function() {
    it('should create an instance of CategoryRequest', function() {
      ...
      //var instance = new OpenApiDefinition.CategoryRequest();
      //expect(instance).to.be.a(OpenApiDefinition.CategoryRequest);
    });
